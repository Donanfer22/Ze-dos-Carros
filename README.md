...
Propriedade de **BORGES MIDIA NEGOCIOS DIGITAIS LTDA (Alavanca AI)**. O acesso, cópia ou distribuição de qualquer parte do código sem autorização expressa é estritamente proibido.
