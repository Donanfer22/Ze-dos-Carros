...
⚠️ **Repositório Privado** Propriedade de **BORGES MÍDIAS DÍGITAL LTDA - ALAVANCA AI)**. O acesso, cópia ou distribuição de qualquer parte do código sem autorização expressa é estritamente proibido.
📋 Sobre o Projeto
O Zé do Carros é uma plataforma de marketplace automotivo de alta tecnologia, desenvolvida para gerenciar a compra, venda e troca de veículos no Brasil com segurança máxima. 
O sistema utiliza o Consultor Zé IA, uma inteligência artificial que consome um banco de dados RAG (Retrieval-Augmented Generation) para suporte em tempo real.
